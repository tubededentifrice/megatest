...
export interface OpenStep { open: string; }
...
export interface ScrollStep { scroll: { up?: number; down?: number; left?: number; right?: number }; }
export interface EvalStep { eval: string; }
export interface IncludeStep { include: string; }
export interface SetViewportStep { 'set-viewport': string; }
